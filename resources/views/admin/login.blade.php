...
<head>
  ...
  <title>Login Atlantis-Plus</title>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand ">
              <a href="/">
                <img src="{{ asset('back_end/dist/assets/img/atlantis.png') }}" alt="logo" width="100" class="shadow-light rounded-circle">
                <img src="{{ asset('back_end/dist/assets/img/smp.png') }}" alt="logo" width="100" class="shadow-light rounded-circle">
              </a>
            </div>
