...
<head>
  ...
  <!-- CSS Libraries -->
  <link rel="stylesheet" href="{{ asset('back_end/dist/assets/modules/jquery-selectric/selectric.css') }}">
...
<body>
        ...
        <div class="row">
          <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
            <div class="login-brand">
              <img src="{{ asset('back_end/dist/') }}assets/img/stisla-fill.svg" alt="logo" width="100" class="shadow-light rounded-circle">
            </div>
  ...
  <!-- JS Libraies -->
  <script src="{{ asset('back_end/dist/assets/modules/jquery-pwstrength/jquery.pwstrength.min.js') }}"></script>
  <script src="{{ asset('back_end/dist/assets/modules/jquery-selectric/jquery.selectric.min.js') }}"></script>

  <!-- Page Specific JS File -->
  <script src="{{ asset('back_end/dist/assets/js/page/auth-register.js') }}"></script>
